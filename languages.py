...
TRANSLATIONS = {
    'uz': {
        ...
        'share_location_prompt': '📍 **Eng yaqin joylashuvni qidirish**\n\nIltimos, o\'zingizning joylashuvingizni yuboring:',
        ...
        'show_location': '📍 Joylashuvni ko\'rsatish',
        ...
        'condition_new_short': '🆕 Ideal',
        'condition_good_short': '✅ Yaxshi',
        'condition_fair_short': '🔄 Ortacha',
    ...
    'ru': {
        ...
        'condition_new_short': '🆕 Идеальное',
        'condition_good_short': '✅ Хорошее',
        'condition_fair_short': '🔄 Среднее',
        'got_it': '✅ Понятно',
        'back': '🔙 Назад',
    ...
    'eng': {
        ...
        'show_location': '📍 Find Nearest Location',
        ...
        'condition_new_short': '🆕 Excellent',
        'condition_good_short': '✅ Good',
        'condition_fair_short': '🔄 Fair',
        'got_it': '✅ Got it',
        'back': '🔙 Back',
